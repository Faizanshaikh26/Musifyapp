...
function DisplayHome() {
  ...
  const { playWithId, albumData } = usePlayer();

  const keywords = useMemo(() => ["Top 100 India", "Top 50 Global", "Trending","Lofi"], []);
  const singleKeywords = useMemo(() => ["Lofi"], []);

  // Update loading state when albumData is fetched
  useEffect(() => {
